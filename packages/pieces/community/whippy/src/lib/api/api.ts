...
export class Contact {
  ...
  static async listContacts(
    ...
    channelsID: any[] | undefined,
    channelsPhone: any[] | undefined
  ): Promise<ApiResponse<any>> {
    const apiParams: APICallParams = {
...
export class Conversation {
  static async listConversations(
    ...
    contactEmail: any[] | undefined,
    lastMessage: object | undefined,
    createdAt: object | undefined,
    updatedAt: object | undefined,
    assignedUsers: any[] | undefined
  ): Promise<ApiResponse<any>> {
    const apiParams: APICallParams = {
...
export class Sequence {
  static async getSequences(
    ...
    const url = `${rootUrl}/sequences?limit=${limit}&offset=${offset}&title=${encodeURIComponent(
      title
    )}`;
  ...
  static async listSequenceRuns(
    ...
    const queryParams = `limit=${limit}&offset=${offset}&phone=${encodeURIComponent(
      phone
    )}&status=${status}&channel_id=${channelId}&before=${encodeURIComponent(
      before
  ...
  static async listSequenceContacts(
    apiKey: string,
    sequenceId: string,
    options: {
      limit: number;
  ...
  static async createSequenceContacts(
    apiKey: string,
    seqID: string,
    fromNumber: string,
    toNumber: object,
...
export class Campaign {
  ...
  static async listCampaignContacts(
    apiKey: string,
    campaignID: string,
    limit: number | undefined,
    offset: number | undefined,
...
export class CustomObject {
  static async createCustomObjects(
    apiKey: string,
    key: string,
    label: string,
  ...
  static async updateCustomObject(
    apiKey: string,
    customId: string,
    recordId: string,
  ...
  static async createCustomProperty(
    apiKey: string,
    customId: string,
    key: string,
    label: string,
  ...
  static async updateCustomProperty(
    apiKey: string,
    customId: string,
    recordId: string,
    propertyId: string,
  ...
  static async createCustomRecord(
    apiKey: string,
    customId: string,
    associatedId: string | undefined,
    recordType: string | undefined,
  ...
  static async listCustomObjects(
    apiKey: string,
    limit: number | undefined,
    offset: number | undefined
  ): Promise<ApiResponse<any>> {
  ...
  static async listCustomProperty(
    apiKey: string,
  ...
  static async listCustomRecords(
    apiKey: string,
    customId: string,
    limit: number | undefined,
    offset: number | undefined,
